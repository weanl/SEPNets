...
def run_test_ARs(exps_dir):
    ...
    test_y_ar_pred = np.concatenate(test_y_ar_pred, axis=-1)  # (batch_size, n_var)
    ...
    # ar model mae
    print('ar_model-overall-mae:\t', mean_absolute_error(test_y, test_y_ar_pred))
    print('ar_model-mae:\n', mean_absolute_error(test_y, test_y_ar_pred, multioutput='raw_values'))

    np.savez_compressed(
        exps_dir+'results/y_ar_pred',
